...
export default class Calendar extends Component {
  ...
  handleFetch(response) {
    ...
    // const schedule = !appointments.length ? initSchedule : appointments.reduce((currentSchedule, appointment) => {
      const schedule = !appointments ? initSchedule : appointments.reduce((currentSchedule, appointment) => {
  ...
  handleSubmit() {
    ...
    axios.post(PORT + "/api/appointments", appointment)
  ...
  componentWillMount() {
    async.series({
      appointments(callback) {
        axios.get(PORT + "/api/appointments").then(res => {
                ...
                <StepContent>
                  <section>
                    ...
                    <RaisedButton
                      ...
                      // might need to put this back in here and ending tag style={{ marginTop: 20, maxWidth: 100 }} 
                      />
                  </section>
                </StepContent>
              </Step>
